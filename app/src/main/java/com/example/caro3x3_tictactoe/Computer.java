...
public class Computer extends AppCompatActivity implements Serializable {
    int[][] c;
    int i, j;
    Button[][] b;
    AI ai;
    ...
    private boolean checkBoard() {
        ...
        if ((c[1][1] == 0 && c[2][2] == 0 && c[3][3] == 0)
            ...
            mediaPlayer = MediaPlayer.create(Computer.this, R.raw.win);
            mediaPlayer.start();
            gameOver = true;
            setBoard();
            ...
            mediaPlayer = MediaPlayer.create(Computer.this, R.raw.loss);
            mediaPlayer.start();
            gameOver = true;
            setBoard();
        } else {
            ...
            if (!empty) {
                ...
                mediaPlayer = MediaPlayer.create(Computer.this, R.raw.draw);
                mediaPlayer.start();
            }
        }
        return gameOver;
